        ...
        <div className="sec-head mb-80 wow fadeInUp">
          <div className="row">
            <div className="col-lg-7">
              ...
              <h3>
                Trusted by <span className="main-color">Our Clients</span>
              </h3>
            </div>
          </div>
        </div>
                  ...
                  <div className="item ">
                    ...
                    <div>
                      <div className="cont mb-30">
                        ...
                        Working with Mohammed was a pleasure. Their clear communication and decisive feedback facilitated the creation of a website that perfectly matched our vision and objectives.
                        </p>
                      </div>
                      <div className="d-flex align-items-center">
                        <div>
                          <div className="img">
                            <img src="/assets/imgs/testim/user.png" alt="" />
                          </div>
                        </div>
                        <div className="ml-30">
                          <div className="info">
                            <h6 className="main-color">Thasnim</h6>
                            <span className="fz-13 mt-10 opacity-8">
                              Former HR - Amana Hospital
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="item d-flex">
                    ...
                    <div>
                      <div className="cont mb-30">
                        ...
                        <p className="fz-20 mt-15">
                        Mohammed was fantastic to collaborate with, providing clear direction and valuable feedback throughout the process. Their vision and enthusiasm ensured the website project was a resounding success.
                        </p>
                      </div>
                      <div className="d-flex align-items-center">
                        <div>
                        ...
                        <div className="ml-30">
                          <div className="info">
                            <h6 className="main-color">Hashir</h6>
                            <span className="fz-13 mt-10 opacity-8">
                              De castle interiors
                            </span>
                          </div>
